...
export const PsikologHome: React.FC = () => {
  return (
    <div className="psikolog-home-wrapper">
      <div className="psikolog-home-title">
      ...
      <div className="psikolog-content-wrapper">
        <div className="psikolog-content-row">
          <div className="psikolog-card-detailprofile">
            <div className="card-detailprofile-info-wrapper">
              <div className="card-detailprofile-photo">
                <img src="/assets/images/profil01.png" alt="profilPicture" />
              </div>
              <div className="card-detailprofile-info">
                ...
                <span className="card-detailprofile-education">Pendidikan</span>
          ...
          <div className="psikolog-home-card-income">
            <div className="card-income-text-wrapper">
              <span className="card-income-text-title">
                Perkiraan Pendapatan
              </span>
              <Link to="#" className="psikolog-home-card-text-detail">
        ...
        <div className="psikolog-content-row">
          ...
          <div className="psikolog-card-client-wrapper">
            <div className="psikolog-card-client-header">
              <div className="psikolog-card-client-header-left">
                <span className="psikolog-card-client-title">Jumlah Klien</span>
            ...
            <div className="psikolog-card-client-content">
              <div className="row">
                ...
                <div className="psikolog-card-client-info">
                  <span className="psikolog-card-client-name">Eunha Jung</span>
                  <span className="psikolog-card-client-email">Eunhajung@email.com</span>
                </div>
                <div className="psikolog-card-client-action">
                  <Button
                    ...
                    size="small"
                    type="circle"
                    style={{ height: 54, width: 54, padding: '6px 10px' }}
                  ></Button>
                  <Button
                    icon="icon-chat"
                    color="primary"
              ...
              <div className="row">
                ...
                <div className="psikolog-card-client-info">
                  <span className="psikolog-card-client-name">Eunha Jung</span>
                  <span className="psikolog-card-client-email">Sana_Minatozaki@email.com</span>
                </div>
                <div className="psikolog-card-client-action">
                  <Button
                    icon="icon-schedule02"
              ...
              <div className="row" style={{ marginTop: 20, justifyContent: 'center' }}>
                <Link className="text-link" to="">Lihat selengkapnya ...</Link>
              </div>
            </div>
          </div>

          <div className="psikolog-card-client-wrapper" style={{width: '52%'}}>
            <div className="psikolog-card-client-header">
              <div className="psikolog-card-client-header-left">
                <span className="psikolog-card-client-total" style={{fontSize: 40}}>List Jadwal</span>
                <span style={{fontSize: 18}}>Segera konfirmasi jadwal dari Klien</span>
              </div>
              <div className="psikolog-card-client-header-right">
            ...
            <div className="psikolog-card-client-content" style={{gap: 0, padding: '50px 40px 30px'}}>
              ...
              <ul className="card-step-wrapper">
                <li className="card-step-item">
                  ...
                  <div className="card-step-action">
                    <Button color="secondary" name="dikonfirmasi" size="small" type="rounded" style={{marginRight: 10}}></Button>
                    <Button color="primary" name="Detail" size="small" type="rounded"></Button>
                  </div>
                </li>
              </ul>
              <ul className="card-step-wrapper">
                <li className="card-step-item">
                  ...
                  <span>Eunha Jung</span>
                  <div className="card-step-action">
                    <Button color="primary" name="Konfirmasi" size="small" type="rounded" style={{marginRight: 10}}></Button>
                    <Button color="primary" name="Detail" size="small" type="rounded"></Button>
                  </div>
                </li>
              </ul>
